...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="" class="logo">
            ...
            <span class="logo-mini"><b>魔</b>镜</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>魔镜</b>后台管理</span>
        </a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    {{$user->name}} - {{ in_array($user->username,config('backend.authority.supers'))?'超级管理员': $user->roles()->first()->name}}
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    ...
                    <a href="#"><i class="fa fa-circle text-success"></i>{{ in_array($user->username,config('backend.authority.supers'))?'超级管理员': $user->roles()->first()->name}}</a>
                </div>
            </div>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2016 <a href="http://www.kankan.com" target="_blank">响巢看看</a>.</strong> All rights
        reserved.
    </footer>
