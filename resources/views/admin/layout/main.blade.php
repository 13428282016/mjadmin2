...
<div class="wrapper">
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    ...
                    <a href="#"><i class="fa fa-circle text-success"></i> Web前端工程师</a>
                </div>
            </div>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2015 <a href="http://www.kankan.com" target="_blank">响巢看看</a>.</strong> All rights reserved.
    </footer>
